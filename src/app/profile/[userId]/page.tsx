...
const ProfileSkeleton = () => (
  <div className="bg-card shadow-md border border-border rounded-lg p-6 mb-8">
...
const ReviewCard = ({ review }: { review: Review }) => (
  <motion.div
    ...
    className="bg-card text-card-foreground border border-border rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300"
  >
    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="container mx-auto pt-24 px-4 sm:px-8">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-card text-card-foreground border border-border shadow-md rounded-lg p-8 mb-8"
        >
            ...
            <div className="relative">
              ...
              {isEditable && (
                <>
                  ...
                  />
                  <button
                    className="absolute bottom-0 right-0 p-2 bg-card rounded-full shadow-md hover:shadow-lg transition-all disabled:opacity-50 border border-border"
