...
const BottomBar: React.FC<Props> = ({ price = 0, eventId }) => {
    ...
    return (
        <div className='flex fixed z-50 bottom-0 px-6 md:px-12 justify-between items-center w-full h-[90px] bg-background/80 backdrop-blur-xl border-t border-border shadow-[0_-4px_24px_rgba(0,0,0,0.05)]'>
            <div className="flex flex-col">
                <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Price per ticket</span>
                <p className="font-bold text-3xl text-foreground">{price === 0 ? "FREE" : `$${price}`}</p>
            </div>
            <Dialog>
                ...
                <DialogContent className="sm:max-w-[550px]">
                    ...
                    <div className='w-full h-full flex justify-between py-4 shadow-xl p-2'>
                        ...
                        <div className='flex flex-row gap-2 items-center'>
                            <Button
                                ...
                                className={ticketsToBuy === 0 ? "text-muted-foreground" : "text-foreground"}
                            ...
                            <Button
                                ...
                                className={ticketsToBuy >= finalMaxLimit ? "text-muted-foreground" : "text-foreground"}
                    ...
                    <DialogFooter className='w-full'>
                        <div className='w-full flex justify-between'>
                            <div>
                                <p className='font-bold text-xl text-foreground'>{`$${price && (price * ticketsToBuy).toFixed(2)}`}</p>
                                <p className='text-xs text-muted-foreground'>{`${ticketsToBuy}x Ticket`}</p>
                            </div>
